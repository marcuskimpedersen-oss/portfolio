...
export default function Publications() {
  return (
    <section
      id="publications"
      className="border-t border-stone-200 py-24 dark:border-stone-800"
    >
          ...
          {publications.map((item, i) => (
            <Animate key={item.title} delay={i * 150}>
              <a
                ...
                className="group block rounded-xl border border-stone-200 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-stone-300 hover:shadow-lg hover:shadow-taupe-500/10 dark:border-stone-800 dark:hover:border-stone-600 dark:hover:shadow-taupe-500/10"
              >
                <div className="mb-2 flex items-center gap-3">
                  <span className="rounded-full bg-taupe-100 px-3 py-1 text-xs font-medium text-taupe-700 dark:bg-taupe-900 dark:text-taupe-300">
                    {item.org}
                  </span>
                </div>
                <h3 className="mb-2 text-lg font-semibold group-hover:text-taupe-600 dark:group-hover:text-taupe-400">
                  {item.title}
                  <span className="ml-2 inline-block text-stone-400 transition-transform group-hover:translate-x-1">
                    &rarr;
                  </span>
                </h3>
